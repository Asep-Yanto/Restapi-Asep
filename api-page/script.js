document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Bruh Api");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 Bruh. All rights reserved.");
        setContent('header', 'textContent', settings.name || "Bruh Api");
        setContent('name', 'textContent', settings.name || "Bruh Api");
